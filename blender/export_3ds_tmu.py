...
bl_info = {
    "name": "Export to 3DS format for TrackMania Forever",
    "author": ["Campbell Barton", "Bob Holcomb", "Richard Lärkäng", "Damien McGinnes", "Mark Stijnman", "Alfonso Garcia", "Bryan Hernandez"],
    "version": (1, 0),
    "blender": (2, 7, 0),
    "location": "File -> Export -> Export to TMF 3DS",
    "description": "Exports selection in a format readable for the game TrackMania Forever",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
...
class OBJECT_OT_tmf_export(Operator,AddonPreferences):
    """TMF export class"""
    bl_idname = 'object.tmf_export'
    bl_label = '3DS to TMF export'
...
def menu_func(self, context):
	...
	self.layout.operator(OBJECT_OT_tmf_export.bl_idname, text="Export to 3DS file")

def register():
	bpy.utils.register_class(OBJECT_OT_tmf_export)

def unregister():
    bpy.utils.unregister_class(OBJECT_OT_tmf_export)
